  ...
  return (
    <div className="flex flex-col justify-center items-center relative">
      ...
      <div className="text-[20px] font-Kanit">
        กรอกข้อมูลที่ใช้ในการประเมิณค่าใช้จ่ายที่จะยื่นขอสิทธิบัตรจนไปถึงการประกาศใช้สิทธิบัตร
      </div>
      ...
      <div></div>
      <CostResultModal isOpen={isFillAll} handleClose={handleClose} selectValue = {selectValue} />
    </div>
  );
};
